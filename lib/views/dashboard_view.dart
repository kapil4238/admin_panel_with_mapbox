import 'package:aegis247_admin_panel/app/app_colors.dart';
...
class HomeScreenDashboardView extends GetView<HomeScreenController> {
  const HomeScreenDashboardView({Key? key}) : super(key: key);
